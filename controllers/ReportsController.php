...
class ReportsController extends Controller
{
     ...
     * @return mixed
     */
    public function actionCreate($idStudent)
    {
        
        $model = new Reports();
        $model->student_id = $idStudent;
        if(empty($idStudent) or empty($model->getStudent())){
     ...
     * @return mixed
     */
    public function actionUpdate($id,$idStudent)
    {
        $model = $this->findModel($id);
